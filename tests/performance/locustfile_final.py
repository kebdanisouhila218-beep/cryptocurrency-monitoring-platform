# tests/performance/locustfile_final.py
"""
Tests de performance avec Locust pour CryptoTracker API (Version finale corrigée)

Usage:
    locust -f locustfile_final.py --host=http://localhost:8000
"""
...
class CryptoTrackerUser(HttpUser):
    ...
    def on_start(self):
        ...
        # Utiliser le compte admin existant avec URL encoding du mot de passe
